...
- Validation checklist or validation script
...
Learners will collect basic system, user, service, network, and package information from an ARM64 Linux VM and explain what the baseline shows.

### Lab 02 — Authentication Log Analysis

Learners will inspect authentication-related logs, identify normal and suspicious login activity, and write a short security findings summary.
